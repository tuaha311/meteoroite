                        ...
                        <div className="single-team-box">
                            <div className="team-image">
                                ...
                                <div className="team-social-icon">
                                    <a href="#" className="social-color-1"><FontAwesomeIcon icon={faFacebook} size="lg" /></a>
                                    <a href="#" className="social-color-2"><FontAwesomeIcon icon={faTwitter} size="lg" /></a>
                                    <a href="#" className="social-color-3"><FontAwesomeIcon icon={faLinkedin} size="lg" /></a>
                                </div>
                            </div>
