                                    ...
                                    <div className="skill-item">
                                        ...
                                        <div className="skill-progress">
                                            <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                                                {({ isVisible }) => (isVisible ? (<div className="progres" data-value="90%" style={{ width: "90%" }}></div>) : (<div className="progres" data-value="1%" style={{ width: "1%" }}></div>))}
                                            </VisibilitySensor>
                                        </div>
                                    </div>
                                    <div className="skill-item">
                                        ...
                                        <div className="skill-progress">
                                            <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                                                {({ isVisible }) => (isVisible ? (<div className="progres" data-value="75%" style={{ width: "75%" }}></div>) : (<div className="progres" data-value="1%" style={{ width: "1%" }}></div>))}
                                            </VisibilitySensor>
                                        </div>
                                    </div>
                                    <div className="skill-item">
                                        ...
                                        <div className="skill-progress">
                                            <VisibilitySensor partialVisibility offset={{ bottom: 200 }}>
                                                {({ isVisible }) => (isVisible ? (<div className="progres" data-value="80%" style={{ width: "80%" }}></div>) : (<div className="progres" data-value="1%" style={{ width: "1%" }}></div>))}
                                            </VisibilitySensor>
                                        </div>
                                    </div>
                                </div>
                                <div className="about-btn-box" style={{ marginTop: "5vh" }}>
                                    <a className="default-btn project-btn-1" href="projects.html">Learn More<span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
